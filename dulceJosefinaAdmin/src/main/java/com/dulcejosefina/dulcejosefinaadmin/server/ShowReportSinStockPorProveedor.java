...
@WebServlet(name = "ShowReportSinStockPorProveedor", urlPatterns = {"/ShowReportSinStockPorProveedor"})
public class ShowReportSinStockPorProveedor extends HttpServlet {
    ...
    String xml = null;
        ...
        try { // Call Web Service Operation
            ...
            xml = port.obtenerProductosSinStockPorProveedor(Long.parseLong(idProveedor));
