...
@WebServlet(name = "ShowReportSinStockPorProveedorFraccionado", urlPatterns = {"/ShowReportSinStockPorProveedorFraccionado"})
public class ShowReportSinStockPorProveedorFraccionado extends HttpServlet {
    ...
    String xml = null;
        ...
        try { // Call Web Service Operation
            ...
            xml = port.obtenerProductosFraccionadosSinStockPorProveedor(Long.parseLong(idProveedor));
                ServletOutputStream servletOutputStream = response.getOutputStream();
    Document doc = reporte.obtenerDocumentoParseado(xml);
    byte[] bytes = reporte.obtenerReporteJasper(doc, "/Lista/item", reporte.obtenerReportFraccionadoSinStockPorProveedor());
    response.setContentType("application/pdf");
